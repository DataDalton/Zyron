...
pub fn lookup_keyword(word: &str) -> Option<Keyword> {
    ...
    match upper {
        ...
        // Zyron-to-Zyron data plane
        "PUBLICATIONS" => Some(Keyword::Publications),
        "SUBSCRIBE" => Some(Keyword::Subscribe),
        "INVOKE" => Some(Keyword::Invoke),
        "ENDPOINT" => Some(Keyword::Endpoint),
        "ENDPOINTS" => Some(Keyword::Endpoints),
        "AUDIENCE" => Some(Keyword::Audience),
        "SCOPE" => Some(Keyword::Scope),
        "SCOPES" => Some(Keyword::Scopes),
        "RATE" => Some(Keyword::Rate),
        "CORS" => Some(Keyword::Cors),
        "ORIGINS" => Some(Keyword::Origins),
        "CREDENTIAL_PROVIDER" => Some(Keyword::CredentialProvider),
        "WEBSOCKET" => Some(Keyword::Websocket),
        "SSE" => Some(Keyword::Sse),
        "BACKED" => Some(Keyword::Backed),
        "HEARTBEAT" => Some(Keyword::Heartbeat),
        "BACKPRESSURE" => Some(Keyword::Backpressure),
        "MTLS" => Some(Keyword::Mtls),
        "FINGERPRINT" => Some(Keyword::Fingerprint),
        "MAP" => Some(Keyword::Map),
        "RESET" => Some(Keyword::Reset),
        "LSN" => Some(Keyword::Lsn),
        "TAG" => Some(Keyword::Tag),
        "UNTAG" => Some(Keyword::Untag),
        "TAGGED" => Some(Keyword::Tagged),
        "INHERIT" => Some(Keyword::Inherit),
        "RETENTION" => Some(Keyword::Retention),
        "CHANGE_FEED" => Some(Keyword::ChangeFeed),
        "ALLOW_INITIAL_SNAPSHOT" => Some(Keyword::AllowInitialSnapshot),
        "VAULT" => Some(Keyword::Vault),
        "IAM_ASSUME_ROLE" => Some(Keyword::IamAssumeRole),
        "K8S_SA_TOKEN" => Some(Keyword::K8sSaToken),
        "AWS_SECRETS_MANAGER" => Some(Keyword::AwsSecretsManager),
        "GCP_SECRET_MANAGER" => Some(Keyword::GcpSecretManager),
        "AZURE_KEY_VAULT" => Some(Keyword::AzureKeyVault),
        "DROP_OLDEST" => Some(Keyword::DropOldest),
        "CLOSE_SLOW" => Some(Keyword::CloseSlow),
        "BLOCK" => Some(Keyword::Block),
        "ABAC" => Some(Keyword::Abac),
        "JWT" => Some(Keyword::Jwt),
        "API_KEY" => Some(Keyword::ApiKey),
        "OAUTH2" => Some(Keyword::OAuth2),
        "BASIC" => Some(Keyword::Basic),
        "KUBERNETES" => Some(Keyword::Kubernetes),
        "ISSUER" => Some(Keyword::Issuer),
        "SUBJECT" => Some(Keyword::Subject),
        "CERT" => Some(Keyword::Cert),
        "REQUIRE" => Some(Keyword::Require),
        "BODY" => Some(Keyword::Body),
        "REQUEST" => Some(Keyword::Request),
        "MAX" => Some(Keyword::Max),
        "IP" => Some(Keyword::Ip),
        "PER" => Some(Keyword::Per),
        "CONNECTIONS" => Some(Keyword::Connections),
        "PROTOCOL" => Some(Keyword::Protocol),
        "ZYRON" => Some(Keyword::Zyron),
        "ANALYZER" => Some(Keyword::Analyzer),
        "SYNONYM" => Some(Keyword::Synonym),
        "DICTIONARY" => Some(Keyword::Dictionary),
        "HYBRID" => Some(Keyword::Hybrid),
        "BULKHEAD" => Some(Keyword::Bulkhead),
        ...
        "VIRTUAL" => Some(Keyword::Virtual),
        "STORED" => Some(Keyword::Stored),
        "ENCRYPTED" => Some(Keyword::Encrypted),
        "OVERLAPS" => Some(Keyword::Overlaps),
        "STRUCT" => Some(Keyword::Struct),
        "LTREE" => Some(Keyword::Ltree),
        "VARIANT" => Some(Keyword::Variant),
        "IMAGE" => Some(Keyword::Image),
        "VIDEO" => Some(Keyword::Video),
        "AUDIO" => Some(Keyword::Audio),
        "DOCUMENT" => Some(Keyword::Document),
        "EXTERNAL_REF" => Some(Keyword::ExternalRef),
        "DATERANGE" => Some(Keyword::Daterange),
        "TSTZRANGE" => Some(Keyword::Tstzrange),
