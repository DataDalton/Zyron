...
const BUFFER_POOL_HIT_RATE_TARGET: f64 = 1.0;
...
const CHECKPOINT_WRITE_THROUGHPUT_TARGET_MB_SEC: f64 = 2000.0;
const CHECKPOINT_WRITE_1M_TARGET_MS: f64 = 3.0;
const CHECKPOINT_LOAD_THROUGHPUT_TARGET_MB_SEC: f64 = 3000.0;
const CHECKPOINT_LOAD_1M_TARGET_MS: f64 = 2.0;
const RECOVERY_WITH_CHECKPOINT_TARGET_MS: f64 = 5.0;
const RECOVERY_SCALE_TARGET_MS: f64 = 20.0;
...
async fn test_checkpoint_scheduler_integration() {
    ...
    use zyron_buffer::{BackgroundWriter, BackgroundWriterConfig, WriteFn};
    use zyron_storage::{
        CheckpointCoordinator, CheckpointCoordinatorConfig, CheckpointScheduler, CheckpointTracker,
    };
